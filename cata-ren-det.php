...
$select = "SELECT be.*, (cc.tNombres + ' ' + cc.tApellidos) as tNombre FROM BitEventos be INNER JOIN CatClientes cc ON cc.eCodCliente = be.eCodCliente WHERE be.eCodEvento = ".$_GET['val'];
...
<div class="row">
    ...
    <form id="datos" name="datos" action="<?=$_SERVER['REQUEST_URI']?>" method="post" enctype="multipart/form-data">
        <input type="hidden" name="eCodEvento" value="<?=$_GET['val']?>">
              ...
              <?=nl2br(base64_decode(utf8_decode($rPublicacion{'tObservaciones'})))?>
								...
								<div class="col-lg-12">
                                    ...
                                    <table class="table table-responsive table-borderless table-top-campaign">
										...
										<tbody>
											<?
											$select = "SELECT bt.fhFecha, bt.dMonto, ctp.tNombre FROM BitTransacciones bt INNER JOIN CatTiposPagos ctp ON ctp.eCodTipoPago = bt.eCodTipoPago WHERE bt.eCodEvento = ".$_GET['val'];
